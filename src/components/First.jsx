      ...
      <motion.div className="first" variants={containerVariants} initial="hidden" animate="visible">
        ...
        <motion.main variants={itemVariants} className='contain'>
          <div className='first3'>
            <motion.div className='a' whileHover={{ scale: 1.00 }} whileTap={{ scale: 0.95 }} onClick={() => window.location.href = 'https://drive.google.com/file/d/1XTVO89fgTY0eY7cnrKz_uN7ZHvcvT0QD/view?usp=sharing'} style={{color:"white"}}> View Resume</motion.div>
